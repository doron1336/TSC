...
def run_pocket(remain_num: int, y_train: List[str], X_train_transform: np.ndarray, y_test: List[str],
               X_test_transform: np.ndarray, directory: str, chromo_df_bc: Optional[List[bool]] = None):
    stop_thr = 0.0001
    num_epochs = 50
    ...
    if chromo_df_bc:
        ...
        new_X_train_transform = X_train_transform
        new_X_test_transform = X_test_transform
